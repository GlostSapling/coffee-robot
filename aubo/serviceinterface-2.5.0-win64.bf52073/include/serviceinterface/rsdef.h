 ...
 * @return RS_SUCC 成功 其他失败
 */
int rs_move_rotate_to_waypoint(RSHD rshd,aubo_robot_namespace::wayPoint_S *target_waypiont, bool isblock = true);
...
/**
 * rs_get_rotate_target_waypiont  根据根据起始点姿态及基坐标系下描述的旋转轴、旋转角，获取目标位姿
 * @param rshd 械臂控制上下文句柄
 ...
 * @return
 */
int rs_get_rotate_target_waypiont(RSHD rshd,const aubo_robot_namespace::wayPoint_S *originateWayPointOnBaseCoord,const double rotateAxisOnBaseCoord[], double rotateAngle,aubo_robot_namespace::wayPoint_S *targetWayPointOnBaseCoord);

/**
 * @brief rs_get_rotateaxis_user_to_Base 将用户坐标系下描述的旋转轴转换到基坐标系下描述
 * @param rshd 械臂控制上下文句柄
 ...
 * @return
 */
int rs_get_rotateaxis_user_to_Base(RSHD rshd,const aubo_robot_namespace::Ori *oriOnUserCoord,const double rotateAxisOnUserCoord[],double rotateAxisOnBaseCoord[]);
 ...
 * @return
 */
int rs_user_coord_calibrate(RSHD rshd, const CoordCalibrate *user_coord, double bInWPos[3], double bInWOri[9], double wInBPos[3]);
 ...
 * @return
 */
int rs_tool_calibration(RSHD rshd,const ToolCalibrate &toolCalibrate,
 ...
 * @return RS_SUCC 成功 其他失败
 */
int rs_startup_excit_traj_track(RSHD rshd, const char *trackfile, char type, char subtype);
 ...
 * @return
 */
int rs_set_track_playback_cycle(RSHD rshd, double second);
 ...
 * @return
 */
bool rs_get_dynidentify_results(RSHD rshd, std::vector<int> &paramVector);
 ...
 * @return
 */
int rs_get_target_waypoint_by_position(RSHD rshd,const aubo_robot_namespace::wayPoint_S       &sourceWayPointOnBaseCoord,
 ...
 * @return
 */
int rs_set_robot_orpe_stop(RSHD rshd,uint8 data);
 ...
 * @return
 */
int rs_set_regulate_speed_param(RSHD rshd, const RegulateSpeedModeParamConfig_t *config);
 ...
 * @return
 */
int rs_get_regulate_speed_param(RSHD rshd, RegulateSpeedModeParamConfig_t *config);
 ...
 * @return
 */
int rs_enable_regulate_speed_mode(RSHD rshd, bool enbaleFlag);
 ...
 * @return
 */
int rs_get_force_control_mode_explore_force_param(RSHD rshd, double *forceLimit, double *distLimit);
 ...
 * @return
 */
int rs_set_force_control_mode_explore_force_param(RSHD rshd, double forceLimit, double distLimit);
 ...
 * @return
 */
int rs_enable_force_control_mode(RSHD rshd, bool enbaleFlag);
 ...
 * @return
 */
int rs_get_realtime_force_data(RSHD rshd, double forceData[6]);
 ...
 * @return
 */
int rs_parse_file_as_roadpoint_collection(RSHD rshd,
                                       const char *filePath,
 ...
 * @return
 */
int rs_parse_roadpoint_file_and_cache_result(RSHD rshd,
...
/**
 * @brief 运行缓存好的轨迹  即：运行rs_parse_roadpoint_file_and_cache_result的结果
 * @return
 */
int rs_move_cached_track(RSHD rshd);
...
//other
const char *rs_str_error(RSHD rshd, int err);
void print_plan(const CoordCalibrate *user_coord);
void print_move_relative_offset(const MoveRelative *relative);
void print_waypoint(wayPoint_S *waypoint);
void print_tool_dynamics(ToolDynamicsParam *tool_dynamics);
